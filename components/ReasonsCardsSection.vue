    ...
    <div class="container mx-auto px-4 md:px-20">
        ...
        >
          ...
          <div class="relative w-full aspect-square bg-gray-100 rounded-lg overflow-hidden group cursor-pointer">
            ...
            <div class="absolute inset-0 flex items-center justify-center p-3">
              <h3 class="font-semibold text-xs md:text-sm text-center text-white leading-tight">
                {{ advantage.title }}
              </h3>
            </div>
          </div>
      ...
      <div class="relative mb-12">
        ...
        <div class="w-full h-[400px] md:h-[500px] bg-gray-100 rounded-lg overflow-hidden relative group">
          <!-- Peta Image -->
          <img
            :src="content.locationSection?.mapImage"
            alt="Peta Lokasi Sanggar Indah Parahyangan"
          ...
          >
            <span class="bg-black/70 text-white text-xs md:text-sm px-4 py-2 rounded-full font-medium flex items-center gap-2">
          ...
          <div class="absolute bottom-6 right-6 z-10">
            <a 
              :href="content.locationSection?.mapUrl" 
              target="_blank"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4 max-w-4xl mx-auto">
          <div 
            v-for="(facility, idx) in content.locationSection?.facilities || []" 
            :key="idx"
