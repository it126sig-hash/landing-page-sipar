    ...
    <div class="container mx-auto px-4 md:px-20">
      ...
      <div class="mt-10 flex flex-col items-center gap-3 text-center">
        ...
        <a
          ...
          class="inline-flex items-center gap-2 rounded-full bg-[#142b20] px-6 py-3 font-body text-sm font-semibold text-white hover:bg-[#0f1f17] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#142b20]"
        >
